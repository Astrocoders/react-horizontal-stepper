  ...
  _createClass(Step, [{
    ...
    value: function getStyles() {
      var _props = this.props,
          ...
          defaultCircleFontColor = _props.defaultCircleFontColor,
      ...
      return {
        ...
        activeTitle: Object.assign({}, {
          color: activeTitleColor,
          opacity: activeTitleOpacity
        }, titleStyle),
        completedTitle: Object.assign({}, {
    ...
    value: function getInnerContent() {
      ...
      if (active) {
        return _react2.default.createElement(
          'a',
          { href: href, onClick: onClick, style: styles.activeIndex },
          index + 1
        );
      }
